...
var brandContents = map[string]BrandContent{
	"en": {
		...
		DownloadsTitle: "Download", DownloadsLead: "Files below are immutable v0.1.0 release artifacts. Keep NOTICE and the applicable license with redistributed files.",
	...
	"pt-br": {
		...
		DownloadsTitle: "Baixar", DownloadsLead: "Os arquivos abaixo são artefatos imutáveis da versão v0.1.0. Inclua NOTICE e a licença aplicável ao redistribuí-los.",
	...
	"es": {
		...
		DownloadsTitle: "Descargar", DownloadsLead: "Los archivos siguientes son artefactos inmutables de v0.1.0. Incluye NOTICE y la licencia aplicable al redistribuirlos.",
