...
func BrandAssetNames() []string {
	return []string{"araihu-favicon.svg", "araihu-mark-reverse.svg", "goshtoso-mark-reverse.svg", "manja-mark-reverse.svg", "paje-mark-reverse.svg", "xisnove-mark-reverse.svg"}
}
